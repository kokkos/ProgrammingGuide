...
The implementation also extends from the proposal in several places (mostly with respect to typos in the latter), all of which are documented in the implemenation repository (link given above).
