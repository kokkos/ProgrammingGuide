\section{Hierarchical Parallelism}\label{C:Hierarchical}
...
\subsection{Thread teams}\label{S:Hierarchical:Teams}
...
\subsubsection{Basic kernels}\label{SS:Hierarchical:Teams:Kernels}
