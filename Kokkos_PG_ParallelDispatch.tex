\section{Parallel dispatch}\label{C:Dispatch}
...
\subsection{Specifying the parallel loop body}
...
\subsubsection{Should I use a functor or a lambda?}
...
\subsubsection{Specifying the execution space}
...
\subsubsection{Example using lambda}
...
\subsubsection{Example using functor}
...
\subsubsection{Example using functor with default join and init}
...
\subsubsection{Reductions with an array of results}
